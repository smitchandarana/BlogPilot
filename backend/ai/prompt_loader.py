...
_PROMPT_NAMES = ["relevance", "comment", "post", "note", "reply", "comment_candidate", "comment_scorer", "post_scorer", "post_with_context", "topic_scorer", "topic_extractor", "content_extractor", "structured_post", "angle_generator"]
